...
IIa = ggplot(data=DFmelt_3, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIb = ggplot(data=DFmelt_4, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE, linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIc = ggplot(data=DFmelt_5, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1,size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IId = ggplot(data=DFmelt_6, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype="solid",size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
