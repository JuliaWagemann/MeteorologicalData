...
IIc = ggplot(data=DFmelt_3, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1,size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIIa = ggplot(data=DFmelt_9, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIIb = ggplot(data=DFmelt_10, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE, linetype=1, size=0.8) +
#  guides(colour=TRUE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIIc = ggplot(data=DFmelt_11, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1,size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
