...
DFmelt_4$panel  <- "IIa"
DFdummy_melt$panel  <- "IIb"
DFdummy_melt2$panel <- "III"
...
Ia = ggplot(data=DFmelt_1, aes(x=value,y=height, color=Profile)) +
...
Ib = ggplot(data=DFmelt_2, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE, linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
Ic = ggplot(data=DFmelt_3, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1,size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
Id = ggplot(data=DFmelt_4, aes(x=value,y=height, color=Profile)) +
...
IIa = ggplot(data=DFmelt_5, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIb = ggplot(data=DFmelt_6, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE, linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIc = ggplot(data=DFmelt_7, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1,size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IId = ggplot(data=DFdummy_melt, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype="solid",size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIIa = ggplot(data=DFmelt_8, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1, size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIIb = ggplot(data=DFmelt_9, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE, linetype=1, size=0.8) +
#  guides(colour=TRUE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIIc = ggplot(data=DFmelt_10, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype=1,size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
...
IIId = ggplot(data=DFdummy_melt2, aes(x=value,y=height, color=Profile)) +
  geom_path(NA.rm=TRUE,linetype="solid",size=0.8) +
  guides(colour=FALSE)+
  scale_colour_manual(values=myPaletteMain) +
  xlim(-60,0) +
