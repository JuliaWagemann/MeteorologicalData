...
###### For 2 Segments #############################################
segments(LWPIntegral_ordered$datetime[1],2.9,LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         2.9, lwd=1.5, col="grey20")
segments(LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],2.9,
         LWPIntegral_ordered$datetime[length(LWPIntegral_ordered$datetime)],2.9,lwd=1.5,
         col="grey20")
...
mtext("I", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[2])
mtext("II", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[23])
