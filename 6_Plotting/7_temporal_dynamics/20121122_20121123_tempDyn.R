...
###### For 2 Segments #############################################
segments(ZIntegral_ordered$datetime[1],2400,ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         2400, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],2400,
         ZIntegral_ordered$datetime[length(ZIntegral_ordered$datetime)],2400,lwd=1.5,
         col="grey20")
...
mtext("IIa", side =3, line = -1.1,adj=0,at=ZIntegral_ordered$datetime[16])
mtext("IIb", side =3, line = -1.1,adj=0,at=ZIntegral_ordered$datetime[55])
