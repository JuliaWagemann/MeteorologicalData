...
fogEvent <- '20121112_20121113_Integrals.csv'
fogEventNr <- 12
...
mtext("IIb", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[67])
mtext("III", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[108])
