...
fogEvent <- '20121119_20121120_Integrals.csv'
fogEventNr <- 13
...
mtext("IIa", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[15])
mtext("IIb", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[73])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[130])
legend("bottomleft",inset=c(0.01,0.01),c("dsd_ground","dsd_profile"),
