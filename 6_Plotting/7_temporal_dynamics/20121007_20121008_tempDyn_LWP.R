...
fogEvent <- '20121007_20121008_Integrals.csv'
fogEventNr <- 5
...
segments(LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],segmentAbstand,
         LWPIntegral_ordered$datetime[breakPoints[2,fogEventNr]],segmentAbstand,lwd=1.5,
         col="grey20")
...
mtext("IIa", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[17])
mtext("IIb", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[53])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[80])
