...
###### For 2 Segments #############################################
segments(LWPIntegral_ordered$datetime[1],77,LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         77, lwd=1.5, col="grey20")
segments(LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],77,
         LWPIntegral_ordered$datetime[length(LWPIntegral_ordered$datetime)],77,lwd=1.5,
         col="grey20")
...
mtext("II", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[7])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[41])
...
legend("right",inset=c(-0.32,0),c('RMSE',
                                  ...
                                  paste('ground_II:',format(round(rmse1_2,2),nsmall=2)),
                                  paste('profile_II:',format(round(rmse2_2,2),nsmall=2)),
