...
fogEvent <- '20120915_20120916_Integrals.csv'
fogEventNr <- 1
...
rmse1_2a <- rmse(LWPIntegral_ordered$LWP_ground[1:breakPoints[1,fogEventNr]],
                LWPIntegral_ordered$LWP_measured_ground[1:breakPoints[1,fogEventNr]],na.rm=T)

rmse2_2a<- rmse(LWPIntegral_ordered$LWP_profile[1:breakPoints[1,fogEventNr]],
               LWPIntegral_ordered$LWP_measured_profile[1:breakPoints[1,fogEventNr]])

rmse1_2b <- rmse(LWPIntegral_ordered$LWP_ground[breakPoints[1,fogEventNr]:breakPoints[2,fogEventNr]],
                 LWPIntegral_ordered$LWP_measured_ground[breakPoints[1,fogEventNr]:breakPoints[2,fogEventNr]],na.rm=T)

rmse2_2b<- rmse(LWPIntegral_ordered$LWP_profile[breakPoints[1,fogEventNr]:breakPoints[2,fogEventNr]],
                LWPIntegral_ordered$LWP_measured_profile[breakPoints[1,fogEventNr]:breakPoints[2,fogEventNr]])

rmse1_3 <- rmse(LWPIntegral_ordered$LWP_ground[breakPoints[2,fogEventNr]:TSLength],
                LWPIntegral_ordered$LWP_measured_ground[breakPoints[2,fogEventNr]:TSLength])

rmse2_3 <- rmse(LWPIntegral_ordered$LWP_profile[breakPoints[2,fogEventNr]:TSLength],
                LWPIntegral_ordered$LWP_measured_profile[breakPoints[2,fogEventNr]:TSLength])
...
###### For 2 Segments #############################################
segments(LWPIntegral_ordered$datetime[1],6.7,LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         6.7, lwd=1.5, col="grey20")
segments(LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],6.7,
         LWPIntegral_ordered$datetime[breakPoints[2,fogEventNr]],6.7,lwd=1.5,
         col="grey20")
segments(LWPIntegral_ordered$datetime[breakPoints[2,fogEventNr]+1],6.7,
         LWPIntegral_ordered$datetime[length(LWPIntegral_ordered$datetime)],6.7,lwd=1.5,
         col="grey20")
...
mtext("IIa", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[14])
mtext("IIb", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[40])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[67])
