...
fogEvent <- '20120917_20120918_Integrals.csv'
fogEventNr <- 2
...
###### For 2 Segments #############################################
segments(ZIntegral_ordered$datetime[1],1400,ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
...
mtext("I", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[8])
mtext("II", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[30])
