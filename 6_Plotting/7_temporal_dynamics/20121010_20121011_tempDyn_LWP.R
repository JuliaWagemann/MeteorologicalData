...
fogEvent <- '20121010_20121011_Integrals.csv'
fogEventNr <- 6
...
mtext("IIa", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[6])
mtext("IIb", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[33])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[65])
