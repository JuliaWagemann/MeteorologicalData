...
###### For 3 Segments #############################################
segments(ZIntegral_ordered$datetime[1],1900,
...
segments(ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],1900,
         ...
         1900, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[2,fogEventNr]+1],1900,
...
mtext("IIa", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[14])
mtext("IIb", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[50])
mtext("III", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[71])
