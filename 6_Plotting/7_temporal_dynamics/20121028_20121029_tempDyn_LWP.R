...
fogEvent <- '20121028_20121029_Integrals.csv'
fogEventNr <- 11
...
mtext("IIb", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[58])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[100])
