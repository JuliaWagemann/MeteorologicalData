...
fogEvent <- '20121020_20121021_Integrals.csv'
fogEventNr <- 8
...
segments(LWPIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],segmentAbstand,
         LWPIntegral_ordered$datetime[breakPoints[2,fogEventNr]-1],segmentAbstand,lwd=1.5,
         col="grey20")
segments(LWPIntegral_ordered$datetime[breakPoints[2,fogEventNr]+1],segmentAbstand,
...
mtext("I", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[5])
mtext("IIa", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[23])
...
legend("right",inset=c(-0.32,0),c('RMSE',
                                  ...
                                  paste('ground_I:',format(round(rmse1_2a,2),nsmall=2)),
                                  paste('profile_I:',format(round(rmse2_2a,2),nsmall=2)),
                                  paste('ground_IIa:',format(round(rmse1_2b,2),nsmall=2)),
                                  paste('profile_IIa:',format(round(rmse2_2b,2),nsmall=2)),
