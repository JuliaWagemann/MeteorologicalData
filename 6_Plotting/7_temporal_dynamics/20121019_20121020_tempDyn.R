...
ZIntegral_ordered[ZIntegral_ordered$diff_ground==0 | 
                    ZIntegral_ordered$diff_ground<(-3000),]<- NA
...
###### For 2 Segments #############################################
segments(ZIntegral_ordered$datetime[1],1900,ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         1900, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],1900,
         ZIntegral_ordered$datetime[length(ZIntegral_ordered$datetime)],1900,lwd=1.5,
         col="grey20")
...
mtext("II", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[10])
mtext("III", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[39])
