...
###### For 3 Segments #############################################
segments(ZIntegral_ordered$datetime[1],1650,
         ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         1650, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],1650,
         ZIntegral_ordered$datetime[breakPoints[2,fogEventNr]-1],
         1650, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[2,fogEventNr]+1],1650,
         ZIntegral_ordered$datetime[length(ZIntegral_ordered$datetime)],1650,lwd=1.5,
         col="grey20")
...
mtext("I", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[5])
mtext("IIa", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[23])
mtext("IIb", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[55])
...
par(xpd=TRUE)
legend("right",inset=c(-0.35,0),c('RMSE',
