...
fogEvent <- '20121023_20121024_Integrals.csv'
fogEventNr <- 10
...
###### For 2 Segments #############################################
segments(ZIntegral_ordered$datetime[1],3400,ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         3400, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],3400,
         ZIntegral_ordered$datetime[length(ZIntegral_ordered$datetime)],3400,lwd=1.5,
         col="grey20")
...
mtext("II", side =3, line = -1.1,adj=0,at=ZIntegral_ordered$datetime[7])
mtext("III", side =3, line = -1.1,adj=0,at=ZIntegral_ordered$datetime[41])
