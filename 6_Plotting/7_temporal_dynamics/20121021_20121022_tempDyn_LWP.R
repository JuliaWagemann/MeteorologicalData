...
fogEvent <- '20121021_20121022_Integrals.csv'
fogEventNr <- 9
...
mtext("IIa", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[3])
mtext("IIb", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[17])
mtext("III", side =3, line = -1.1,adj=0,at=LWPIntegral_ordered$datetime[45])
