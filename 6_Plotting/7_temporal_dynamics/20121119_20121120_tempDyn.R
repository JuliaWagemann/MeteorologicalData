...
###### For 3 Segments #############################################
segments(ZIntegral_ordered$datetime[1],4900,
         ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]-1],
         4900, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[1,fogEventNr]+1],4900,
         ZIntegral_ordered$datetime[breakPoints[2,fogEventNr]-1],
         4900, lwd=1.5, col="grey20")
segments(ZIntegral_ordered$datetime[breakPoints[2,fogEventNr]+1],4900,
         ZIntegral_ordered$datetime[length(ZIntegral_ordered$datetime)],4900,lwd=1.5,
         col="grey20")
...
mtext("IIa", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[15])
mtext("IIb", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[73])
mtext("III", side =3, line = -1.2,adj=0,at=ZIntegral_ordered$datetime[130])
