...
IIa =grobTree(textGrob("I", x=0.03,hjust=0,y=0.98, gp=gpar(fontsize=7),vjust=1))
IIb = grobTree(textGrob("II", x=0.03, hjust=0,y=0.98,gp=gpar(fontsize=7),vjust=1))
...
secondText = grobTree(textGrob("II", x=pos2, hjust=0,y=0.98,gp=gpar(fontsize=7),vjust=1))
