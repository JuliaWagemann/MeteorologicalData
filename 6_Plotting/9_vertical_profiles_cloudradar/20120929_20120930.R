...
i <- "20120929_20120930_cloudinfo_dbz.csv"
fogEvent <- 3
...
firstText =grobTree(textGrob("IIa", x=pos1,hjust=0,y=0.94, vjust=1))
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.94,vjust=1))
