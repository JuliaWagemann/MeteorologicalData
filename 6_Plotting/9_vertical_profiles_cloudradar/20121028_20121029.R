...
i <- "20121028_20121029_cloudinfo_dbz.csv"
fogEvent <- 11
...
firstText =grobTree(textGrob("IIa", x=pos1,hjust=0,y=0.98, vjust=1))
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.98,vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.98,vjust=1))
