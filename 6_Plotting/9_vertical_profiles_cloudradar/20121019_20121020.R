...
i <- "20121019_20121020_cloudinfo_dbz.csv"
fogEvent <- 7
...
secondText = grobTree(textGrob("II", x=pos2, hjust=0,y=0.94,vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.94,vjust=1))
