...
IIa =grobTree(textGrob("I", x=0.03,hjust=0,y=0.99,gp=gpar(fontsize=7), vjust=1))
IIb = grobTree(textGrob("IIa", x=0.03, hjust=0,y=0.99,gp=gpar(fontsize=7),vjust=1))
III = grobTree(textGrob("IIb", x=0.03, hjust=0,y=0.99,gp=gpar(fontsize=7),vjust=1))
...
firstText =grobTree(textGrob("I", x=0.4,hjust=0,y=0.96,gp=gpar(fontsize=7), vjust=1))
secondText = grobTree(textGrob("IIa", x=pos2, hjust=0,y=0.96,gp=gpar(fontsize=7),vjust=1))
thirdText = grobTree(textGrob("IIb", x=pos3, hjust=0,y=0.96,gp=gpar(fontsize=7),vjust=1))
