...
i <- "20121023_20121024_cloudinfo_dbz.csv"
fogEvent <- 10
...
c11 <- c(0,0,0,0)
c22 <- c(fogMain_current[1]+c2[1]-1,fogMain_current[1]+c2[2]-1)
...
secondText = grobTree(textGrob("II", x=pos2, hjust=0,y=0.99,vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.99,vjust=1))
