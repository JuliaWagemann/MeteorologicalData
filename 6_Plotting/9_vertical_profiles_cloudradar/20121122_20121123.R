...
i <- "20121122_20121123_cloudinfo_dbz.csv"
fogEvent <- 16
...
c22 <- c(fogMain_current[2]+c2[1]-1,fogMain_current[2]+c2[2]-1,fogMain_current[2]+c1[3]-1,fogMain_current[2]+c1[4]-1)
...
IIa =grobTree(textGrob("IIa", x=0.03,hjust=0,y=0.99, vjust=1))
IIb = grobTree(textGrob("IIb", x=0.03, hjust=0,y=0.99,vjust=1))
...
firstText =grobTree(textGrob("IIa", x=pos1,hjust=0,y=0.92, vjust=1))
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.92,vjust=1))
#thirdText = grobTree(textGrob("III", x=0.73, hjust=0,y=0.97,vjust=1))
