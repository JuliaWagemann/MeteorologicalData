...
IIb = grobTree(textGrob("IIb", x=0.03, hjust=0,y=0.98,gp=gpar(fontsize=7vjust=1))
III = grobTree(textGrob("III", x=0.03, hjust=0,y=0.98,gp=gpar(fontsize=7vjust=1))
...
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.98,gp=gpar(fontsize=7vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.98,gp=gpar(fontsize=7vjust=1))
