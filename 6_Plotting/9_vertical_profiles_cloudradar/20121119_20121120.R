...
firstText =grobTree(textGrob("IIa", x=pos1,hjust=0,y=0.97, vjust=1))
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.97,vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.97,vjust=1))
