...
IIb = grobTree(textGrob("II", x=0.03, hjust=0,y=0.99,vjust=1))
III = grobTree(textGrob("III", x=0.03, hjust=0,y=0.99,vjust=1))
...
firstText =grobTree(textGrob("I", x=0.55,hjust=0,y=0.78, vjust=1))
secondText = grobTree(textGrob("II", x=pos2, hjust=0,y=0.78,vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.78,vjust=1))
