...
firstText =grobTree(textGrob("IIa", x=pos1,hjust=0,y=0.96,gp=gpar(fontsize=7), vjust=1))
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.96,gp=gpar(fontsize=7),vjust=1))
