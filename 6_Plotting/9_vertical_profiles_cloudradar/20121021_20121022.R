...
i <- "20121021_20121022_cloudinfo_dbz.csv"
fogEvent <- 9
...
c11 <- c(fogMain_current[1]+c1[1]-1,fogMain_current[1]+c1[2]-1)
c22 <- c(fogMain_current[2]+c2[1]-1,fogMain_current[2]+c2[2]-1,fogMain_current[2]+c2[3]-1)
...
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.92,vjust=1))
