...
i <- "20121010_20121011_cloudinfo_dbz.csv"
fogEvent <- 6
...
c11 <- c(fogMain_current[1]+c1[1]-1,fogMain_current[1]+c1[2]-1,fogMain_current[1]+c1[3]-1)
...
firstText =grobTree(textGrob("IIa", x=pos1,hjust=0,y=0.90, vjust=1))
secondText = grobTree(textGrob("IIb", x=pos2, hjust=0,y=0.90,vjust=1))
thirdText = grobTree(textGrob("III", x=pos3, hjust=0,y=0.90,vjust=1))
