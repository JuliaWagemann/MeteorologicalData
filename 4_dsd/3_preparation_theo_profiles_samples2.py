...
'''
###############################################################################
# Script 3_preparation_theo_profiles_samples2
# Author: Julia Wagemann
# Date: February 2014
#
# This script retrieves all the necessary parameters in order to calculate
...
pathCloudTop  = 'H:/Masterarbeit/2_Data/3_fog_time_series/dsd/cloudradar_cloudinfo2/' 
# Path to temperature at cloud base height
pathCloudBaseTemp  = 'H:/Masterarbeit/2_Data/3_fog_time_series/dsd/campbell_Samples2/' 
# Path to vertical z profiles
pathZVal  = 'H:/Masterarbeit/2_Data/3_fog_time_series/dsd/cloudradar_zSamples2/'
...
def getParamsInFile(inputCloudTop,inputCloudBaseTemp,inputZ,inputOmega):
    arrayCloudTop = np.loadtxt(open(pathCloudTop+inputCloudTop,"rb"),delimiter =",",usecols=range(1,4),skiprows=1)
    ...
    outputfile1 = open(pathOmega+'params/'+inputZ[:-15]+'_paramsGround_2.csv','w')
    outputfile2 = open(pathOmega+'params/'+inputZ[:-15]+'_paramsProfile_2.csv','w')
    dateTimeList= []
...
# Testing environment
###########################################################################	
fileList1 = getFilesInList(pathCloudTop, '*_Samples2.csv')    
fileList2 = getFilesInList(pathCloudBaseTemp, '*_Samples2.csv')    
fileList3 = getFilesInList(pathZVal, '*_ZProfiles2.csv')      
